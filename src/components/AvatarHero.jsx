...
export default function AvatarHero() {
  ...
  return (
    <div
      className={`avatarHero ${isTickled ? "isTickled" : ""}`}
      ref={containerRef}
      aria-hidden="true"
    >
      <style>{css}</style>
      ...
      <div className="wrapper">
        ...
        <div className="background-circle">
          ...
          <div
            className="body"
            onMouseEnter={() => setIsTickled(true)}
            onMouseLeave={() => setIsTickled(false)}
            onFocus={() => setIsTickled(true)}
            onBlur={() => setIsTickled(false)}
            tabIndex={0}
          ></div>
